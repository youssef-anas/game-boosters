...
const list3 = valuesAsList.slice(15, valuesAsList.length + 1) || "There is no extra fields" // values of extended order as {is_Arena_2x2}
...
const MMR_PRICE = parseFloat(valuesAsList[14]) || 0
