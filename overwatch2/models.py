...
class Overwatch2Mark(models.Model):
    ...
    tier = models.OneToOneField(Overwatch2Tier, related_name='tier_mark', on_delete=models.CASCADE)
...
class Overwatch2DivisionOrder(models.Model):
    ...
    current_rank = models.ForeignKey(Overwatch2Rank, on_delete=models.CASCADE, default=None, related_name='current_rank',blank=True, null=True)
    reached_rank = models.ForeignKey(Overwatch2Rank, on_delete=models.CASCADE, default=None, related_name='reached_rank',blank=True, null=True)
    desired_rank = models.ForeignKey(Overwatch2Rank, on_delete=models.CASCADE, default=None, related_name='desired_rank',blank=True, null=True)
