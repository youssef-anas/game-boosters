...
from gameBoosterss.views import index, last_orders, privacy_policy, download_media_zip, social_auth_exception_handler, facebook_data_deletion_handler, StoreView, HowWeWorkView, SendMailTest
